  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Get the help you need quickly and easily with our
                      intuitive ticketing system. Submit tickets, track their
                      progress, and communicate directly with our support team
                      all in one place.
                    </p>
                  </Link>
                </NavigationMenuLink>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink asChild className={navigationMenuTriggerStyle()}>
            <Link href="/about-us">About Microsoft Desk</Link>
          </NavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>
    </NavigationMenu>
